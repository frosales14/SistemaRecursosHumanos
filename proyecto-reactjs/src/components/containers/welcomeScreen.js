...
import { Grid, makeStyles, Typography, Container, Hidden } from '@material-ui/core';
...
const WelcomeScreen = () => {
    const {textoPrincipal, textoSecundario, boton,contenido, imagenPrincipal} = useStyles();
    return (
        <Layout>
